...
Route::get('trackings/register', 'TrackingsController@ShowNewUserForm')->name('showNewUserForm');
Route::get('trackings/invoice', 'TrackingsController@ShowInvoiceForm')->name('showInvoiceForm');
